...
def detect_and_crop_face(image_pil):
    ...
    # Take the largest detected face (assuming one main subject)
...
color_recommendations = {
    "very_light": {
        "description": "Soft pastel tones enhance gentle undertones beautifully.",
        "colors": ["#F4C2C2", "#FFD1DC", "#E0BBE4", "#C1E1C1", "#B0E0E6"]
    },
    "light": {
        "description": "Light, airy shades like sky blue, peach, and lavender look flattering.",
        "colors": ["#A7C7E7", "#FFB6C1", "#FFFACD", "#E6E6FA", "#98FB98"]
    },
    "light_medium": {
        "description": "Warm and neutral tones such as coral, turquoise, and plum work perfectly.",
        "colors": ["#FF7F50", "#AFEEEE", "#D8BFD8", "#FFDAB9", "#F5DEB3"]
    },
    "medium": {
        "description": "Earthy colors like olive, rust, and mustard enhance your natural glow.",
        "colors": ["#808000", "#B7410E", "#DAA520", "#F4A460", "#CD853F"]
    },
    "medium_deep": {
        "description": "Rich jewel tones — emerald, navy, burgundy — make you stand out.",
        "colors": ["#800000", "#191970", "#006400", "#483D8B", "#8B0000"]
    },
    "olive": {
        "description": "Warm metallics and soft tones — copper, gold, and rose — bring balance.",
        "colors": ["#B87333", "#FFD700", "#E6BE8A", "#D4AF37", "#DAA520"]
    },
    "tan": {
        "description": "Tropical and bright shades like teal, coral, and white are perfect for you.",
        "colors": ["#20B2AA", "#FF7F50", "#F5F5F5", "#FFA07A", "#40E0D0"]
    },
    "deep": {
        "description": "Royal shades — blue, emerald, magenta — complement deep tones best.",
        "colors": ["#00008B", "#228B22", "#8B008B", "#800080", "#9932CC"]
    },
    "dark": {
        "description": "Bold contrasts like white, gold, and red make your tone pop beautifully.",
        "colors": ["#FFFFFF", "#FFD700", "#DC143C", "#FF8C00", "#32CD32"]
    },
    "very_dark": {
        "description": "Vibrant and metallic tones — cobalt, fuchsia, bronze — look stunning.",
...
st.write("Upload an image, and the app will detect your face, classify your skin tone, and suggest outfit colors!")
...
if uploaded_file is not None:
    ...
    if cropped_face is None:
        ...
        # Layout: Left = Face image, Right = Predictions
        col1, col2 = st.columns([1, 1])

        with col1:
            st.image(cropped_face, caption="Detected Face", width=280, use_container_width=False)
